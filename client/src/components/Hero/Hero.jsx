  ...
  return (
    <section className="relative flex flex-col justify-between h-screen px-6 py-10 overflow-hidden bg-black select-none md:px-14">
      ...
      <div className="z-10 w-full mb-6 animate-fadeInUp">
        <h1 className="max-w-5xl text-2xl font-bold leading-tight text-white sm:text-4xl md:text-5xl">
        ...
        <div className="z-10 py-6 mt-2 space-y-5 md:py-10 md:space-y-6 md:w-5/12 animate-fadeInUp">
      ...
      {/* Floating Image */}
      <div className="absolute right-0 z-0 bottom-14 animate-float hidden sm:block">
        <img
          src="/images/Hero.png"
          alt="Hero graphic"
          className="w-[600px] sm:w-[800px] md:w-[900px] max-w-none"
        />
      </div>
    </section>
  );
