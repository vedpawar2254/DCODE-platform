...
//               {/* Code snippet UI */}
//               <div className="mt-8">
//                 <div className="bg-[#23252B] rounded-lg p-4 text-left overflow-x-auto">
//                   <pre className="text-[#C6FF3D] text-sm md:text-base font-mono whitespace-pre-wrap break-words">
// {`# Fork this repository using GitHub CLI\ngh repo fork DCODE-HQ/DCODE-platform`}
//                   </pre>
//                 </div>
//               </div>
//             </div>
...
function Completion({ onRestart }) {
  return (
    ...
    >
      ...
      <div className="mt-8">
        <Button className="rounded-xl" onClick={onRestart}>
          Start Over
        </Button>
      </div>
    </motion.div>
