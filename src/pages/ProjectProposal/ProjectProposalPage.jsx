...
import { ArrowLeft, Plus, X, Upload, Code, GitBranch, Globe, Users, Sparkles, FileText, Github, Star, ExternalLink, Folder } from 'lucide-react';
...
const ProjectProposalPage = () => {
  ...
  const validateForm = () => {
    ...
    // URL validations
    if (formData.repositoryUrl && !/^https:\/\/(github|gitlab|bitbucket)\.com\/.+/.test(formData.repositoryUrl)) {
      newErrors.repositoryUrl = 'Repository URL must be a valid Git repo (GitHub, GitLab, or Bitbucket)';
    }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setToast({ show: true, message: 'Project proposal submitted successfully!', isError: false });
      setFormData({
        name: '',
        description: '',
        imageUrl: '',
      ...
      setToast({ 
        show: true, 
        message: err.response?.data?.message || 'Failed to submit project proposal. Please try again.', 
        isError: true 
      });
    } finally {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
                             ...
                             <h1 className="text-3xl lg:text-4xl font-semibold leading-tight" style={{ fontFamily: 'Poppins' }}>
                 Submit Your <span className="text-[#BCDD19]">Project</span>
               </h1>
              
              <p className="text-gray-400 text-md leading-relaxed">
                Share your innovative project with the DCODE community. Connect with mentors, showcase your skills, and bring your ideas to life.
              </p>
            </div>
             ...
             <div className="relative w-full h-full min-h-[600px]">
               ...
               <div className="absolute inset-0 bg-gradient-to-br from-[#BCDD19]/5 via-gray-900/20 to-transparent rounded-2xl border border-[#BCDD19]/10">
                 ...
                 <div className="absolute inset-0 opacity-20">
                   ...
                   <div className="absolute bottom-20 right-20 w-40 h-40 bg-[#BCDD19]/20 rounded-full blur-xl animate-pulse-slow" style={{animationDelay: '2s'}}></div>
                   <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-24 h-24 bg-[#BCDD19]/25 rounded-full blur-lg animate-pulse-slow" style={{animationDelay: '1s'}}></div>
                 </div>
                 ...
                 <div className="relative z-10 p-8 space-y-6">
                   ...
                   <div className="text-center mb-8">
                     <h3 className="text-xl font-semibold text-gray-200 mb-2">What You'll Submit</h3>
                     <p className="text-gray-400 text-sm">Your project will be showcased with these details</p>
                   </div>
                   ...
                   <div className="bg-gray-800/60 rounded-xl p-6 border border-gray-700 mb-6">
                     <div className="flex items-start space-x-4">
                       ...
                       <div className="flex-1">
                         <h4 className="text-gray-200 font-semibold mb-2">Your Project Name</h4>
                         <p className="text-gray-400 text-sm mb-3">A brief description of your innovative project and what makes it unique...</p>
                         <div className="flex flex-wrap gap-2 mb-3">
                           <span className="bg-[#BCDD19]/20 text-[#BCDD19] px-2 py-1 rounded-full text-xs">React</span>
                           <span className="bg-[#BCDD19]/20 text-[#BCDD19] px-2 py-1 rounded-full text-xs">Node.js</span>
                           <span className="bg-[#BCDD19]/20 text-[#BCDD19] px-2 py-1 rounded-full text-xs">MongoDB</span>
                         </div>
                   ...
                   <div className="space-y-4">
                     <h4 className="text-lg font-semibold text-gray-200 mb-4">Why Submit Your Project?</h4>
                     ...
                     <div className="space-y-3">
                       <div className="flex items-center space-x-3">
                         ...
                         <span className="text-gray-300 text-sm">Get feedback from experienced mentors</span>
                       </div>
                       ...
                       <div className="flex items-center space-x-3">
                         ...
                         <span className="text-gray-300 text-sm">Showcase your work to the community</span>
                       </div>
                       ...
                       <div className="flex items-center space-x-3">
                         ...
                         <span className="text-gray-300 text-sm">Connect with other developers</span>
                       </div>
                       ...
                       <div className="flex items-center space-x-3">
                         ...
                         <span className="text-gray-300 text-sm">Build your portfolio and reputation</span>
                       </div>
                     </div>
                   </div>
                   ...
                   <div className="absolute bottom-4 left-4 w-12 h-12 bg-[#BCDD19]/15 rounded-lg animate-float" style={{animationDelay: '1s'}}></div>
                   <div className="absolute top-1/3 right-8 w-8 h-8 bg-[#BCDD19]/20 rounded-full animate-float" style={{animationDelay: '2s'}}></div>
          ...
          <div className="space-y-8">
            ...
            {toast.show && (
              <div
                role="alert"
                aria-live="polite"
                             className={`fixed top-4 right-4 p-4 rounded-lg shadow-lg transition-all duration-300 text-sm sm:text-base z-50 ${
               toast.isError ? 'bg-red-600 text-white' : 'bg-[#BCDD19] text-black'
             }`}
              >
                {toast.message}
              </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="bg-gray-900/40 border border-gray-800 rounded-lg p-6">
                <h2 className="text-xl font-semibold mb-6 text-gray-200">Project Details</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <p className="text-gray-500 text-xs mt-2">{formData.name.length}/100 characters</p>
                  </div>

                  <div>
                    <label htmlFor="assignedMentor" className="block text-sm font-medium text-gray-300 mb-2">
                    Maintainer Name *  
                    </label>
                    <input
                      id="assignedMentor"
                      ...
                      maxLength={50}
                    />
                    {errors.assignedMentor && <p className="text-red-400 text-xs mt-2">{errors.assignedMentor}</p>}
                  </div>
                </div>
                ...
                <div className="mt-6">
                  ...
                  <p className="text-gray-500 text-xs mt-2">{formData.description.length}/1000 characters</p>
                </div>
              </div>

              {/* Links & URLs */}
              <div className="bg-gray-900/40 border border-gray-800 rounded-lg p-6">
                <h2 className="text-xl font-semibold mb-6 text-gray-200">Links & URLs</h2>
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    />
                    {errors.repositoryUrl && <p className="text-red-400 text-xs mt-2">{errors.repositoryUrl}</p>}
                    <p className="text-gray-500 text-xs mt-2">Supports GitHub, GitLab, and Bitbucket</p>
                  </div>

                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      <label htmlFor="liveDemoUrl" className="block text-sm font-medium text-gray-300 mb-2">
                        Live Demo URL
                      </label>
                      <input
                        id="liveDemoUrl"
                      ...
                      />
                      {errors.liveDemoUrl && <p className="text-red-400 text-xs mt-2">{errors.liveDemoUrl}</p>}
                    </div>
              ...
              {/* Tech Stack & Tags */}
              <div className="bg-gray-900/40 border border-gray-800 rounded-lg p-6">
                <h2 className="text-xl font-semibold mb-6 text-gray-200">Tech Stack & Tags</h2>
