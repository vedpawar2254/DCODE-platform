...
const EmailVerification = () => {
  ...
  const { verifyEmail, resendVerificationEmail, loading, authUser } = useAuthStore();
    ...
    const verifyEmailToken = async () => {
      try {
        ...
        if (result.success) {
          ...
          if (result.message?.includes('expired') || result.message?.includes('Expired')) {
        ...
        return (
          ...
          >
            ...
            <p className="text-[#A1A1AA] mb-6 leading-relaxed">
              {message || 'Your email has been verified. You will be redirected to your dashboard shortly.'}
            </p>
      ...
      default:
        return (
          ...
          >
            ...
            <p className="text-[#A1A1AA] mb-6 leading-relaxed">
              {message || 'Unable to verify your email address. The verification link may be invalid or expired.'}
            </p>
